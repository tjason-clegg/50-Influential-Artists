...
Its an easier way to organize your code to minimize how much you have to read through

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?

Favorite concept is by far being able to write sections of code on different pages. Least favorite is probably variables, they sometimes dont work and take time to look into why they arent working.

3. How would you explain the concept of a variable to someone new to programming?

Its something we use to store data that we can use later

4. What is the purpose of using functions in code?

Making so its easier to run many lines of code with one line instead without repeating the code itself

5. What is a JSON data?

JavaScript Object Notation. Its a way to format, store, and transport data.
